...
import { profilePhotoResize, photoUpload } from "../middlewares/upload/photoUpload.js";
...
userRoutes.put('/profile', authMiddleware, photoUpload.single("image"), profilePhotoResize, uploadProfilePhoto);
